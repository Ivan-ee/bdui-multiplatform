(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).br = function () {
    return this.ar_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.ar_1[index];
  };
  ...
  protoOf(AtomicRef).cr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).dr = function () {
  ...
  protoOf(AtomicBoolean).er = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).dr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).fr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).dr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).gr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).dr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).br);
  //endregion
