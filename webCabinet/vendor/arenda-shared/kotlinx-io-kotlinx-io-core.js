(function (factory) {
  ...
  var IllegalArgumentException_init_$Create$_0 = kotlin_kotlin.$_$.f4;
  ...
  var Exception_init_$Init$ = kotlin_kotlin.$_$.a4;
  var captureStack = kotlin_kotlin.$_$.fa;
  var Exception_init_$Init$_0 = kotlin_kotlin.$_$.b4;
  var Exception_init_$Init$_1 = kotlin_kotlin.$_$.d4;
  ...
  function write$default(source, startIndex, endIndex, $super) {
    ...
    var tmp;
    if ($super === VOID) {
      this.lp(source, startIndex, endIndex);
      tmp = Unit_instance;
    } else {
      tmp = $super.lp.call(this, source, startIndex, endIndex);
    }
    return tmp;
  }
  ...
  protoOf(Buffer).eo = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
  ...
  protoOf(Buffer).fo = function () {
    ...
    var v = segment.oo();
    this.ao_1 = subtract(this.ao_1, new Long(1, 0));
    if (segmentSize === 1) {
      this.no();
    }
    return v;
  };
  protoOf(Buffer).po = function () {
    var tmp0_elvis_lhs = this.yn_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
    ...
    var segmentSize = segment.d1();
    if (segmentSize < 2) {
      this.do(new Long(2, 0));
      if (segmentSize === 0) {
        this.no();
        return this.po();
      }
      // Inline function 'kotlinx.io.and' call
      var tmp_0 = (this.fo() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.fo() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.qo();
    this.ao_1 = subtract(this.ao_1, new Long(2, 0));
    if (segmentSize === 2) {
      this.no();
    }
    return v;
  ...
  protoOf(Buffer).so = function (out, startIndex, endIndex) {
    ...
    out.ao_1 = add(out.ao_1, remainingByteCount);
    var s = this.yn_1;
    while (compare(currentOffset, fromInt(ensureNotNull(s).io_1 - s.ho_1 | 0)) >= 0) {
      currentOffset = subtract(currentOffset, fromInt(s.io_1 - s.ho_1 | 0));
      s = s.lo_1;
    }
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var copy = ensureNotNull(s).to();
      copy.ho_1 = copy.ho_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.ho_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.io_1;
      tmp.io_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.yn_1 == null) {
        out.yn_1 = copy;
        out.zn_1 = copy;
      } else if (false) {
        out.zn_1 = ensureNotNull(out.zn_1).uo(copy).vo();
        if (ensureNotNull(out.zn_1).mo_1 == null) {
          out.yn_1 = out.zn_1;
        }
      } else {
        out.zn_1 = ensureNotNull(out.zn_1).uo(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.io_1 - copy.ho_1 | 0));
  ...
  protoOf(Buffer).wo = function () {
    ...
    if (equalsLong(result, new Long(0, 0)))
      return new Long(0, 0);
    var tail = ensureNotNull(this.zn_1);
    if (tail.io_1 < 8192 && tail.ko_1) {
      result = subtract(result, fromInt(tail.io_1 - tail.ho_1 | 0));
    }
    return result;
  };
  protoOf(Buffer).xo = function (position) {
    ...
    if (equalsLong(position, new Long(0, 0))) {
      return ensureNotNull(this.yn_1).yo(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.yn_1 == null) {
        var offset = new Long(-1, -1);
        return ensureNotNull(null).yo(convertToInt(subtract(position, offset)));
      }
      if (compare(subtract(this.d1(), position), position) < 0) {
        var s = this.zn_1;
        var offset_0 = this.d1();
        $l$loop: while (!(s == null) && compare(offset_0, position) > 0) {
          offset_0 = subtract(offset_0, fromInt(s.io_1 - s.ho_1 | 0));
        ...
        return ensureNotNull(tmp0).yo(convertToInt(subtract(position, offset_1)));
      } else {
        var s_0 = this.yn_1;
        ...
        return ensureNotNull(tmp0_1).yo(convertToInt(subtract(position, offset_3)));
      }
    }
  };
  protoOf(Buffer).s2 = function () {
    return this.zo(this.d1());
  };
  protoOf(Buffer).zo = function (byteCount) {
    ...
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      ...
      var b = head.io_1 - head.ho_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = compare(tmp0, b_0) <= 0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.ao_1 = subtract(this.ao_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.ho_1 = head.ho_1 + toSkip | 0;
      if (head.ho_1 === head.io_1) {
        this.no();
      }
    }
  };
  protoOf(Buffer).ap = function (sink, startIndex, endIndex) {
    ...
    s.bp(sink, startIndex, startIndex + toCopy | 0);
    this.ao_1 = subtract(this.ao_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.no();
    }
    return toCopy;
  };
  protoOf(Buffer).cp = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.dp(this, bytesWritten);
    return bytesWritten;
  };
  protoOf(Buffer).ep = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.dp(this, byteCount);
  };
  protoOf(Buffer).fp = function (sink) {
  ...
  protoOf(Buffer).hp = function (minimumCapacity) {
    // Inline function 'kotlin.require' call
    ...
    if (this.zn_1 == null) {
      var result = SegmentPool_instance.kp();
      this.yn_1 = result;
      this.zn_1 = result;
      return result;
    }
    var t = ensureNotNull(this.zn_1);
    if ((t.io_1 + minimumCapacity | 0) > 8192 || !t.ko_1) {
      var newTail = t.uo(SegmentPool_instance.kp());
      this.zn_1 = newTail;
      return newTail;
    }
    return t;
  };
  protoOf(Buffer).lp = function (source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.mp();
      var toCopy = Math.min(tmp0, b);
      tail.np(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.ao_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.ao_1 = add(tmp0_0, fromInt(other));
  };
  protoOf(Buffer).pp = function (source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var read = source.cp(this, remainingByteCount);
  ...
  protoOf(Buffer).dp = function (source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    checkOffsetAndCount(source.ao_1, new Long(0, 0), byteCount);
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      if (compare(remainingByteCount, fromInt(ensureNotNull(source.yn_1).d1())) < 0) {
        var tail = this.zn_1;
        var tmp;
        if (!(tail == null) && tail.ko_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.io_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.qp() ? 0 : tail.ho_1;
        ...
        if (tmp) {
          ensureNotNull(source.yn_1).sp(tail, convertToInt(remainingByteCount));
          source.ao_1 = subtract(source.ao_1, remainingByteCount);
          this.ao_1 = add(this.ao_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.yn_1 = ensureNotNull(source.yn_1).rp(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.yn_1);
      var movedByteCount = fromInt(segmentToMove.d1());
      source.yn_1 = segmentToMove.tp();
      if (source.yn_1 == null) {
        source.zn_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.yn_1 == null) {
        ...
        this.zn_1 = segmentToMove;
      } else if (true) {
        this.zn_1 = ensureNotNull(this.zn_1).uo(segmentToMove).vo();
        if (ensureNotNull(this.zn_1).mo_1 == null) {
          this.yn_1 = this.zn_1;
        }
      } else {
        this.zn_1 = ensureNotNull(this.zn_1).uo(segmentToMove);
      }
      source.ao_1 = subtract(source.ao_1, movedByteCount);
      this.ao_1 = add(this.ao_1, movedByteCount);
      remainingByteCount = subtract(remainingByteCount, movedByteCount);
    }
  };
  protoOf(Buffer).up = function (source) {
    var totalBytesRead = new Long(0, 0);
    $l$loop: while (true) {
      var readCount = source.cp(this, new Long(8192, 0));
  ...
  protoOf(Buffer).vp = function (byte) {
    this.hp(1).wp(byte);
    this.ao_1 = add(this.ao_1, new Long(1, 0));
  };
  protoOf(Buffer).xp = function (short) {
    this.hp(2).yp(short);
    this.ao_1 = add(this.ao_1, new Long(2, 0));
  };
  protoOf(Buffer).y3 = function () {
    return Unit_instance;
  };
  protoOf(Buffer).toString = function () {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.d1()) {
        ...
        var b_0 = tmp0.zp(segment, _unary__edvuaz);
  ...
  protoOf(Buffer).no = function () {
    var oldHead = ensureNotNull(this.yn_1);
    var nextHead = oldHead.lo_1;
    this.yn_1 = nextHead;
    if (nextHead == null) {
      this.zn_1 = null;
    } else {
    ...
    oldHead.lo_1 = null;
    SegmentPool_instance.aq(oldHead);
  };
  protoOf(Buffer).bq = function () {
    var oldTail = ensureNotNull(this.zn_1);
    var newTail = oldTail.mo_1;
    this.zn_1 = newTail;
    if (newTail == null) {
      this.yn_1 = null;
    } else {
    ...
    oldTail.mo_1 = null;
    SegmentPool_instance.aq(oldTail);
  };
    ...
    $l$block_1: {
      ...
      if (compare(subtract(_this__u8e3s4.d1(), startIndex), startIndex) < 0) {
        ...
        do {
          ...
          segment_0 = segment_0.lo_1;
        }
         while (!(segment_0 == null) && compare(offset_1, endOffset) < 0);
        return new Long(-1, -1);
      } else {
        var s_0 = _this__u8e3s4.yn_1;
        var offset_2 = new Long(0, 0);
        $l$loop_0: while (!(s_0 == null)) {
          var tmp0_4 = offset_2;
          // Inline function 'kotlin.Long.plus' call
          var other_1 = s_0.io_1 - s_0.ho_1 | 0;
  ...
  function readByteString(_this__u8e3s4, byteCount) {
    return UnsafeByteStringOperations_instance.xn(readByteArray_0(_this__u8e3s4, byteCount));
  }
  ...
  function PeekSource(upstream) {
    this.cq_1 = upstream;
    this.dq_1 = this.cq_1.bo();
    this.eq_1 = this.dq_1.yn_1;
    var tmp = this;
    var tmp0_safe_receiver = this.dq_1.yn_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.ho_1;
    tmp.fq_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.gq_1 = false;
    this.hq_1 = new Long(0, 0);
  }
  protoOf(PeekSource).cp = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!!this.gq_1) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.eq_1 == null || (this.eq_1 === this.dq_1.yn_1 && this.fq_1 === ensureNotNull(this.dq_1.yn_1).ho_1))) {
    ...
    if (!this.cq_1.eo(tmp$ret$7))
      return new Long(-1, -1);
    if (this.eq_1 == null && !(this.dq_1.yn_1 == null)) {
      this.eq_1 = this.dq_1.yn_1;
      this.fq_1 = ensureNotNull(this.dq_1.yn_1).ho_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.dq_1.d1(), this.hq_1);
    var toCopy = compare(byteCount, b) <= 0 ? byteCount : b;
    this.dq_1.so(sink, this.hq_1, add(this.hq_1, toCopy));
    this.hq_1 = add(this.hq_1, toCopy);
    return toCopy;
  };
  protoOf(PeekSource).y3 = function () {
    this.gq_1 = true;
  };
  function RealSource(source) {
    this.iq_1 = source;
    this.jq_1 = false;
    this.kq_1 = new Buffer();
  }
  protoOf(RealSource).bo = function () {
    return this.kq_1;
  };
  protoOf(RealSource).cp = function (sink, byteCount) {
    ...
    if (equalsLong(this.kq_1.d1(), new Long(0, 0))) {
      var read = this.iq_1.cp(this.kq_1, new Long(8192, 0));
      if (equalsLong(read, new Long(-1, -1)))
        return new Long(-1, -1);
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.kq_1.cp(sink, toRead);
  };
  protoOf(RealSource).co = function () {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.jq_1) {
      var message = 'Source is closed.';
    ...
    return this.kq_1.co() && equalsLong(this.iq_1.cp(this.kq_1, new Long(8192, 0)), new Long(-1, -1));
  };
  protoOf(RealSource).do = function (byteCount) {
    if (!this.eo(byteCount))
      throw EOFException_init_$Create$_0("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  };
  protoOf(RealSource).eo = function (byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.jq_1) {
      var message = 'Source is closed.';
    ...
    while (compare(this.kq_1.d1(), byteCount) < 0) {
      if (equalsLong(this.iq_1.cp(this.kq_1, new Long(8192, 0)), new Long(-1, -1)))
        return false;
    }
    return true;
  };
  protoOf(RealSource).fo = function () {
    this.do(new Long(1, 0));
    return this.kq_1.fo();
  };
  protoOf(RealSource).ap = function (sink, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    var size = sink.length;
    checkBounds(fromInt(size), fromInt(startIndex), fromInt(endIndex));
    if (equalsLong(this.kq_1.d1(), new Long(0, 0))) {
    ...
    return this.kq_1.ap(sink, startIndex, startIndex + toRead | 0);
  };
  protoOf(RealSource).ep = function (sink, byteCount) {
    try {
      this.do(byteCount);
    } catch ($p) {
      if ($p instanceof EOFException) {
        var e = $p;
        sink.dp(this.kq_1, this.kq_1.d1());
        throw e;
      } else {
        throw $p;
      }
    }
    this.kq_1.ep(sink, byteCount);
  };
  protoOf(RealSource).fp = function (sink) {
    var totalBytesWritten = new Long(0, 0);
    while (!equalsLong(this.iq_1.cp(this.kq_1, new Long(8192, 0)), new Long(-1, -1))) {
      var emitByteCount = this.kq_1.wo();
      if (compare(emitByteCount, new Long(0, 0)) > 0) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.dp(this.kq_1, emitByteCount);
      }
    }
    if (compare(this.kq_1.d1(), new Long(0, 0)) > 0) {
      totalBytesWritten = add(totalBytesWritten, this.kq_1.d1());
      sink.dp(this.kq_1, this.kq_1.d1());
    }
    return totalBytesWritten;
  };
  protoOf(RealSource).po = function () {
    this.do(new Long(2, 0));
    return this.kq_1.po();
  };
  ...
  protoOf(RealSource).y3 = function () {
    if (this.jq_1)
      return Unit_instance;
    this.jq_1 = true;
    this.iq_1.y3();
  ...
  protoOf(RealSource).toString = function () {
    return 'buffered(' + toString(this.iq_1) + ')';
  };
  function Segment_init_$Init$($this) {
    Segment.call($this);
    $this.go_1 = new Int8Array(8192);
    $this.ko_1 = true;
    $this.jo_1 = null;
    return $this;
  }
  ...
  protoOf(Segment).to = function () {
    ...
    // Inline function 'kotlin.also' call
    t.qq();
    return Segment_init_$Create$_0(this.go_1, tmp_0, tmp_1, t, false);
  };
  protoOf(Segment).tp = function () {
    var result = this.lo_1;
    if (!(this.mo_1 == null)) {
      ensureNotNull(this.mo_1).lo_1 = this.lo_1;
    }
    if (!(this.lo_1 == null)) {
      ensureNotNull(this.lo_1).mo_1 = this.mo_1;
    }
    this.lo_1 = null;
    this.mo_1 = null;
    return result;
  };
  protoOf(Segment).uo = function (segment) {
    segment.mo_1 = this;
    segment.lo_1 = this.lo_1;
    if (!(this.lo_1 == null)) {
      ensureNotNull(this.lo_1).mo_1 = segment;
    }
    this.lo_1 = segment;
    return segment;
  };
  protoOf(Segment).rp = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.io_1 - this.ho_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.kp();
      var tmp0 = this.go_1;
      var tmp2 = prefix.go_1;
      var tmp5 = this.ho_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.ho_1 + byteCount | 0;
    ...
    prefix.io_1 = prefix.ho_1 + byteCount | 0;
    this.ho_1 = this.ho_1 + byteCount | 0;
    if (!(this.mo_1 == null)) {
      ensureNotNull(this.mo_1).uo(prefix);
    } else {
      prefix.lo_1 = this;
      this.mo_1 = prefix;
    }
  ...
  protoOf(Segment).vo = function () {
    ...
    if (!ensureNotNull(this.mo_1).ko_1)
      return this;
    var byteCount = this.io_1 - this.ho_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.mo_1).io_1 | 0) + (ensureNotNull(this.mo_1).qp() ? 0 : ensureNotNull(this.mo_1).ho_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.mo_1;
    this.sp(ensureNotNull(predecessor), byteCount);
    var successor = this.tp();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
    SegmentPool_instance.aq(this);
    return predecessor;
  };
  protoOf(Segment).wp = function (byte) {
    var _unary__edvuaz = this.io_1;
    this.io_1 = _unary__edvuaz + 1 | 0;
    this.go_1[_unary__edvuaz] = byte;
  };
  protoOf(Segment).yp = function (short) {
    var data = this.go_1;
    var limit = this.io_1;
  ...
  protoOf(Segment).oo = function () {
    var _unary__edvuaz = this.ho_1;
    this.ho_1 = _unary__edvuaz + 1 | 0;
    return this.go_1[_unary__edvuaz];
  };
  protoOf(Segment).qo = function () {
    var data = this.go_1;
    var pos = this.ho_1;
  ...
  protoOf(Segment).sp = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!sink.ko_1) {
      var message = 'only owner can write';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    if ((sink.io_1 + byteCount | 0) > 8192) {
      if (sink.qp())
        throw IllegalArgumentException_init_$Create$_0();
      if (((sink.io_1 + byteCount | 0) - sink.ho_1 | 0) > 8192)
        throw IllegalArgumentException_init_$Create$_0();
      var tmp0 = sink.go_1;
      var tmp2 = sink.go_1;
      var tmp5 = sink.ho_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.io_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.io_1 = sink.io_1 - sink.ho_1 | 0;
      sink.ho_1 = 0;
    }
    var tmp0_0 = this.go_1;
    var tmp2_0 = sink.go_1;
    var tmp4 = sink.io_1;
    var tmp6 = this.ho_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.ho_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.io_1 = sink.io_1 + byteCount | 0;
    this.ho_1 = this.ho_1 + byteCount | 0;
  };
  protoOf(Segment).bp = function (dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.go_1;
    var tmp6 = this.ho_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.ho_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.ho_1 = this.ho_1 + len | 0;
  };
  protoOf(Segment).np = function (src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.go_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.io_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.io_1 = this.io_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  };
  protoOf(Segment).d1 = function () {
    return this.io_1 - this.ho_1 | 0;
  };
  protoOf(Segment).mp = function () {
    return this.go_1.length - this.io_1 | 0;
  };
  protoOf(Segment).rq = function (readOnly) {
    return this.go_1;
  };
  protoOf(Segment).yo = function (index) {
    return this.go_1[this.ho_1 + index | 0];
  };
  protoOf(Segment).sq = function (index, value) {
    this.go_1[this.io_1 + index | 0] = value;
  };
  protoOf(Segment).tq = function (index, b0, b1) {
    var d = this.go_1;
    var l = this.io_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  };
  protoOf(Segment).uq = function (index, b0, b1, b2) {
    var d = this.go_1;
    var l = this.io_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(Segment).vq = function (index, b0, b1, b2, b3) {
    var d = this.go_1;
    var l = this.io_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(AlwaysSharedCopyTracker).oq = function () {
    return true;
  };
  protoOf(AlwaysSharedCopyTracker).qq = function () {
    return Unit_instance;
  };
  ...
  function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
    ...
    var p = _this__u8e3s4.ho_1;
    var data = _this__u8e3s4.rq(true);
  ...
  function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
    ...
    $l$loop: while (true) {
      ...
      if (compare(offset, endIndex) < 0) {
        ...
        tmp_0 = _this__u8e3s4.eo(tmp$ret$2);
      } else {
        tmp_0 = false;
      }
      if (!tmp_0) {
  ...
  function readByteArrayImpl(_this__u8e3s4, size) {
    ...
    if (size === -1) {
      ...
      while (compare(_this__u8e3s4.bo().d1(), new Long(2147483647, 0)) < 0 && _this__u8e3s4.eo(fetchSize)) {
        // Inline function 'kotlin.Long.times' call
        var this_0 = fetchSize;
        fetchSize = multiply(this_0, fromInt(2));
      }
      // Inline function 'kotlin.check' call
      if (!(compare(_this__u8e3s4.bo().d1(), new Long(2147483647, 0)) < 0)) {
        var message = "Can't create an array of size " + _this__u8e3s4.bo().d1().toString();
        throw IllegalStateException_init_$Create$(toString(message));
      }
      arraySize = convertToInt(_this__u8e3s4.bo().d1());
    } else {
      _this__u8e3s4.do(fromInt(size));
    }
    var array = new Int8Array(arraySize);
    readTo(_this__u8e3s4.bo(), array);
    return array;
  }
  function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
    ...
    while (offset < endIndex) {
      var bytesRead = _this__u8e3s4.ap(sink, offset, endIndex);
      if (bytesRead === -1) {
  ...
  function readString(_this__u8e3s4, byteCount) {
    _this__u8e3s4.do(byteCount);
    return commonReadUtf8(_this__u8e3s4.bo(), byteCount);
  }
  function readString_0(_this__u8e3s4) {
    return commonReadUtf8(_this__u8e3s4, _this__u8e3s4.d1());
  }
  function readString_1(_this__u8e3s4) {
    _this__u8e3s4.eo(new Long(-1, 2147483647));
    return commonReadUtf8(_this__u8e3s4.bo(), _this__u8e3s4.bo().d1());
  }
    ...
    while (i < endIndex) {
      ...
      if (c < 128) {
        $l$block_0: {
          ...
          ctx.zq(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
          $l$loop: while (i < runLimit) {
            ...
            ctx.zq(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
          }
          var bytesWritten = i + segmentOffset | 0;
          if (bytesWritten === 1) {
            tail.io_1 = tail.io_1 + bytesWritten | 0;
            var tmp = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_3 = this_0.ao_1;
            tmp.ao_1 = add(this_3, fromInt(bytesWritten));
            break $l$block_0;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten ? bytesWritten <= tail.mp() : false)) {
            var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.mp();
            throw IllegalStateException_init_$Create$(toString(message));
          }
          if (!(bytesWritten === 0)) {
            tail.io_1 = tail.io_1 + bytesWritten | 0;
            var tmp_0 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_4 = this_0.ao_1;
            tmp_0.ao_1 = add(this_4, fromInt(bytesWritten));
            break $l$block_0;
          }
          if (isEmpty(tail)) {
            this_0.bq();
        ...
        $l$block_2: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_0 = this_0.hp(2);
          get_SegmentWriteContextImpl().yq(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
          var bytesWritten_0 = 2;
          if (bytesWritten_0 === 2) {
            tail_0.io_1 = tail_0.io_1 + bytesWritten_0 | 0;
            var tmp_1 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_5 = this_0.ao_1;
            tmp_1.ao_1 = add(this_5, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.mp() : false)) {
            var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.mp();
          ...
          if (!(bytesWritten_0 === 0)) {
            ...
            var tmp_2 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_6 = this_0.ao_1;
            tmp_2.ao_1 = add(this_6, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          if (isEmpty(tail_0)) {
            this_0.bq();
        ...
        $l$block_4: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_1 = this_0.hp(3);
          get_SegmentWriteContextImpl().xq(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
          var bytesWritten_1 = 3;
          if (bytesWritten_1 === 3) {
            tail_1.io_1 = tail_1.io_1 + bytesWritten_1 | 0;
            var tmp_3 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_7 = this_0.ao_1;
            tmp_3.ao_1 = add(this_7, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.mp() : false)) {
            var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.mp();
            throw IllegalStateException_init_$Create$(toString(message_1));
          }
          if (!(bytesWritten_1 === 0)) {
            tail_1.io_1 = tail_1.io_1 + bytesWritten_1 | 0;
            var tmp_4 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_8 = this_0.ao_1;
            tmp_4.ao_1 = add(this_8, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          if (isEmpty(tail_1)) {
            this_0.bq();
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          this_0.vp(toByte(tmp$ret$29));
          i = i + 1 | 0;
        } else {
          var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
          $l$block_6: {
            // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
            var tail_2 = this_0.hp(4);
            get_SegmentWriteContextImpl().wq(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
            var bytesWritten_2 = 4;
            if (bytesWritten_2 === 4) {
              tail_2.io_1 = tail_2.io_1 + bytesWritten_2 | 0;
              var tmp_6 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_11 = this_0.ao_1;
              tmp_6.ao_1 = add(this_11, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            // Inline function 'kotlin.check' call
            if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.mp() : false)) {
              var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.mp();
            ...
            if (!(bytesWritten_2 === 0)) {
              ...
              var tmp_7 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_12 = this_0.ao_1;
              tmp_7.ao_1 = add(this_12, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            if (isEmpty(tail_2)) {
              this_0.bq();
  ...
  protoOf(SegmentReadContextImpl$1).zp = function (segment, offset) {
    return segment.yo(offset);
  };
  function SegmentWriteContextImpl$1() {
  }
  protoOf(SegmentWriteContextImpl$1).zq = function (segment, offset, value) {
    segment.sq(offset, value);
  };
  protoOf(SegmentWriteContextImpl$1).yq = function (segment, offset, b0, b1) {
    segment.tq(offset, b0, b1);
  };
  protoOf(SegmentWriteContextImpl$1).xq = function (segment, offset, b0, b1, b2) {
    segment.uq(offset, b0, b1, b2);
  };
  protoOf(SegmentWriteContextImpl$1).wq = function (segment, offset, b0, b1, b2, b3) {
    segment.vq(offset, b0, b1, b2, b3);
  };
  function BufferIterationContextImpl$1() {
  }
  protoOf(BufferIterationContextImpl$1).zp = function (segment, offset) {
    return get_SegmentReadContextImpl().zp(segment, offset);
  };
  ...
  protoOf(SegmentPool).kp = function () {
    return Companion_instance.nq();
  };
  protoOf(SegmentPool).aq = function (segment) {
  };
  protoOf(SegmentPool).pq = function () {
  ...
  protoOf(Buffer).op = write$default;
  //endregion
  //region block: init
