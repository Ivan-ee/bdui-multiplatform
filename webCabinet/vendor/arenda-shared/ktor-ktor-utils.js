(function (factory) {
  ...
  var AbstractMutableSet = kotlin_kotlin.$_$.z4;
  var UnsupportedOperationException_init_$Create$ = kotlin_kotlin.$_$.x4;
  var AbstractMutableCollection = kotlin_kotlin.$_$.y4;
  ...
  var get_lastIndex = kotlin_kotlin.$_$.od;
  ...
  var CoroutineDispatcher = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.i1;
  ...
  var isNaN_0 = kotlin_kotlin.$_$.ng;
  ...
  var LinkedHashMap_init_$Create$_0 = kotlin_kotlin.$_$.m3;
  ...
  var startCoroutineUninterceptedOrReturnNonGeneratorVersion = kotlin_kotlin.$_$.p8;
  var initMetadataForLambda = kotlin_kotlin.$_$.ab;
  //endregion
  //region block: pre-declaration
  initMetadataForClass(AttributeKey, 'AttributeKey');
  function get(key) {
    var tmp0_elvis_lhs = this.e2b(key);
    var tmp;
  ...
  function get_0(name) {
    var tmp0_safe_receiver = this.m2d(name);
    return tmp0_safe_receiver == null ? null : firstOrNull(tmp0_safe_receiver);
  }
  function forEach(body) {
    // Inline function 'kotlin.collections.forEach' call
    var _iterator__ex2g4s = this.g2d().t();
  ...
  protoOf(AttributeKey).toString = function () {
    return 'AttributeKey: ' + this.b2b_1;
  };
  ...
  protoOf(AttributeKey).equals = function (other) {
    ...
    if (!(other instanceof AttributeKey))
      return false;
    if (!(this.b2b_1 === other.b2b_1))
      return false;
    if (!this.c2b_1.equals(other.c2b_1))
      return false;
    return true;
  };
  function Attributes() {
  ...
  function putAll(_this__u8e3s4, other) {
    // Inline function 'kotlin.collections.forEach' call
    var _iterator__ex2g4s = other.k2b().t();
    while (_iterator__ex2g4s.u()) {
      var element = _iterator__ex2g4s.v();
      _this__u8e3s4.g2b(element instanceof AttributeKey ? element : THROW_CCE(), other.d2b(element));
    }
  }
  function advance($this) {
    $l$loop: while ($this.l2b_1 < $this.n2b_1.s2b_1) {
      var idx = $this.n2b_1.r2b_1[$this.l2b_1];
      if (idx >= 0 && !($this.n2b_1.o2b_1[idx] == null))
        break $l$loop;
  ...
  protoOf(CaseInsensitiveMap$KeySet$iterator$1).u = function () {
    return this.l2b_1 < this.n2b_1.s2b_1;
  };
  protoOf(CaseInsensitiveMap$KeySet$iterator$1).v = function () {
    if (!this.u())
      throw NoSuchElementException_init_$Create$();
    var idx = this.n2b_1.r2b_1[this.l2b_1];
    this.m2b_1 = ensureNotNull(this.n2b_1.o2b_1[idx]);
    this.l2b_1 = this.l2b_1 + 1 | 0;
    advance(this);
    return ensureNotNull(this.m2b_1);
  };
  protoOf(CaseInsensitiveMap$KeySet$iterator$1).a4 = function () {
    var tmp0_elvis_lhs = this.m2b_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
  ...
  function advance_0($this) {
    $l$loop: while ($this.x2b_1 < $this.z2b_1.s2b_1) {
      var idx = $this.z2b_1.r2b_1[$this.x2b_1];
      if (idx >= 0 && !($this.z2b_1.o2b_1[idx] == null))
        break $l$loop;
  ...
  protoOf(CaseInsensitiveMap$ValueCollection$iterator$1).u = function () {
    return this.x2b_1 < this.z2b_1.s2b_1;
  };
  protoOf(CaseInsensitiveMap$ValueCollection$iterator$1).v = function () {
    if (!this.u())
      throw NoSuchElementException_init_$Create$();
    var idx = this.z2b_1.r2b_1[this.x2b_1];
    this.y2b_1 = ensureNotNull(this.z2b_1.o2b_1[idx]);
    var tmp = this.z2b_1.p2b_1[idx];
    var result = !(tmp == null) ? tmp : THROW_CCE();
    this.x2b_1 = this.x2b_1 + 1 | 0;
    advance_0(this);
    return result;
  };
  protoOf(CaseInsensitiveMap$ValueCollection$iterator$1).a4 = function () {
    var tmp0_elvis_lhs = this.y2b_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw IllegalStateException_init_$Create$('next() must be called before remove()');
    } else {
  ...
  function advance_1($this) {
    $l$loop: while ($this.a2c_1 < $this.c2c_1.s2b_1) {
      var idx = $this.c2c_1.r2b_1[$this.a2c_1];
      if (idx >= 0 && !($this.c2c_1.o2b_1[idx] == null))
        break $l$loop;
  ...
  protoOf(CaseInsensitiveMap$EntrySet$iterator$1).u = function () {
    return this.a2c_1 < this.c2c_1.s2b_1;
  };
  protoOf(CaseInsensitiveMap$EntrySet$iterator$1).v = function () {
    if (!this.u())
      throw NoSuchElementException_init_$Create$();
    var idx = this.c2c_1.r2b_1[this.a2c_1];
    this.b2c_1 = ensureNotNull(this.c2c_1.o2b_1[idx]);
    var tmp = ensureNotNull(this.b2c_1);
    var tmp_0 = this.c2c_1.p2b_1[idx];
    var entry = new MapEntry(this.c2c_1, tmp, !(tmp_0 == null) ? tmp_0 : THROW_CCE());
    this.a2c_1 = this.a2c_1 + 1 | 0;
    advance_1(this);
    return entry;
  };
  protoOf(CaseInsensitiveMap$EntrySet$iterator$1).a4 = function () {
    var tmp0_elvis_lhs = this.b2c_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw IllegalStateException_init_$Create$('next() must be called before remove()');
    } else {
  ...
  function putWithoutTrackingOrderReturnIndex($this, key, value) {
    ...
    var index = hash & ($this.o2b_1.length - 1 | 0);
    while (true) {
      var existingKey = $this.o2b_1[index];
      if (existingKey == null) {
        $this.o2b_1[index] = key;
        $this.p2b_1[index] = value;
        $this.q2b_1 = $this.q2b_1 + 1 | 0;
        return index;
      }
      ...
      index = (index + 1 | 0) & ($this.o2b_1.length - 1 | 0);
    }
  }
  ...
  function ensureCapacity($this) {
    if (imul($this.q2b_1, 4) >= imul($this.o2b_1.length, 3)) {
      resize($this, imul($this.o2b_1.length, 2));
    }
  }
  function resize($this, newCapacity) {
    var oldKeys = $this.o2b_1;
    var oldValues = $this.p2b_1;
    var oldInsertionOrder = $this.r2b_1;
    var oldInsertionCount = $this.s2b_1;
    var tmp = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp.o2b_1 = Array(newCapacity);
    var tmp_0 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.p2b_1 = Array(newCapacity);
    var tmp_1 = $this;
    var tmp_2 = 0;
    ...
    if (inductionVariable < oldInsertionCount)
      do {
        ...
        if (oldIndex >= 0 && !(oldKeys[oldIndex] == null)) {
          ...
          $this.d2c(tmp_4, !(tmp_5 == null) ? tmp_5 : THROW_CCE());
        }
      }
  ...
  function compactInsertionOrder($this) {
    ...
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var idx = $this.r2b_1[i];
        if (idx >= 0 && !($this.o2b_1[idx] == null)) {
          var tmp = $this.r2b_1;
  ...
  protoOf(KeySet).d1 = function () {
    return this.e2c_1.q2b_1;
  };
  protoOf(KeySet).f2c = function (element) {
  ...
  protoOf(KeySet).b1 = function (element) {
    return this.f2c((!(element == null) ? typeof element === 'string' : false) ? element : THROW_CCE());
  };
  protoOf(KeySet).g2c = function (element) {
    return this.e2c_1.h2c(element);
  };
  protoOf(KeySet).h2 = function (element) {
    if (!(!(element == null) ? typeof element === 'string' : false))
      return false;
    return this.g2c((!(element == null) ? typeof element === 'string' : false) ? element : THROW_CCE());
  };
  protoOf(KeySet).t = function () {
    return new CaseInsensitiveMap$KeySet$iterator$1(this.e2c_1);
  };
  ...
  protoOf(ValueCollection).d1 = function () {
    return this.i2c_1.q2b_1;
  };
  protoOf(ValueCollection).j2c = function (element) {
  ...
  protoOf(ValueCollection).b1 = function (element) {
    return this.j2c(!(element == null) ? element : THROW_CCE());
  };
  protoOf(ValueCollection).t = function () {
    return new CaseInsensitiveMap$ValueCollection$iterator$1(this.i2c_1);
  };
  ...
  protoOf(EntrySet).d1 = function () {
    return this.k2c_1.q2b_1;
  };
  protoOf(EntrySet).l2c = function (element) {
  ...
  protoOf(EntrySet).b1 = function (element) {
    return this.l2c((!(element == null) ? isInterface(element, MutableEntry) : false) ? element : THROW_CCE());
  };
  protoOf(EntrySet).t = function () {
    return new CaseInsensitiveMap$EntrySet$iterator$1(this.k2c_1);
  };
  ...
  protoOf(MapEntry).equals = function (other) {
    if (!(!(other == null) ? isInterface(other, Entry) : false))
      return false;
    return equals_0(this.m2c_1, other.l1()) && equals_0(this.m1(), other.m1());
  };
  protoOf(MapEntry).hashCode = function () {
    return getStringHashCode(this.m2c_1) ^ hashCode(this.m1());
  };
  protoOf(MapEntry).toString = function () {
    return this.m2c_1 + '=' + toString(this.m1());
  };
  function Companion() {
  ...
  function CaseInsensitiveMap() {
    ...
    this.o2b_1 = Companion_getInstance().q2c_1;
    this.p2b_1 = Companion_getInstance().r2c_1;
    this.q2b_1 = 0;
    this.r2b_1 = Companion_getInstance().s2c_1;
    this.s2b_1 = 0;
    this.t2b_1 = null;
    this.u2b_1 = null;
    this.v2b_1 = null;
  ...
  protoOf(CaseInsensitiveMap).h2c = function (key) {
  ...
  protoOf(CaseInsensitiveMap).t2c = function (key) {
    var index = findIndex(this, key);
    return index >= 0 ? this.p2b_1[index] : null;
  };
  ...
  protoOf(CaseInsensitiveMap).s2 = function () {
    if (this.q2b_1 > 0) {
      fill(this.o2b_1, null);
      fill(this.p2b_1, null);
      fill_0(this.r2b_1, -1);
      this.q2b_1 = 0;
      this.s2b_1 = 0;
    }
  };
  protoOf(CaseInsensitiveMap).d2c = function (key, value) {
    if (this.o2b_1 === Companion_getInstance().q2c_1) {
      var tmp = this;
      // Inline function 'kotlin.arrayOfNulls' call
      tmp.o2b_1 = Array(8);
      var tmp_0 = this;
    ...
    while (true) {
      ...
      if (existingKey == null) {
        ensureCapacity(this);
        index = hash & (this.o2b_1.length - 1 | 0);
        while (!(this.o2b_1[index] == null)) {
          index = (index + 1 | 0) & (this.o2b_1.length - 1 | 0);
        }
        if (this.s2b_1 === this.r2b_1.length) {
          compactInsertionOrder(this);
        }
        this.o2b_1[index] = key;
        this.p2b_1[index] = value;
        var tmp_4 = this.r2b_1;
  ...
  protoOf(CaseInsensitiveMap).w2 = function (key, value) {
    ...
    return this.d2c(tmp, !(value == null) ? value : THROW_CCE());
  };
  protoOf(CaseInsensitiveMap).u2c = function (from) {
    // Inline function 'kotlin.collections.forEach' call
  ...
  protoOf(CaseInsensitiveMap).w2b = function (key) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (this.r2b_1[i] === index) {
          this.r2b_1[i] = -1;
          break $l$loop;
        }
      }
       while (inductionVariable < last);
    this.o2b_1[index] = null;
    this.p2b_1[index] = null;
    this.q2b_1 = this.q2b_1 - 1 | 0;
    var nextIndex = (index + 1 | 0) & (this.o2b_1.length - 1 | 0);
    while (!(this.o2b_1[nextIndex] == null)) {
      var rehashKey = ensureNotNull(this.o2b_1[nextIndex]);
      var rehashValue = this.p2b_1[nextIndex];
      var oldRehashIndex = nextIndex;
      this.o2b_1[nextIndex] = null;
      this.p2b_1[nextIndex] = null;
      this.q2b_1 = this.q2b_1 - 1 | 0;
      var newIndex = putWithoutTrackingOrderReturnIndex(this, rehashKey, !(rehashValue == null) ? rehashValue : THROW_CCE());
      var inductionVariable_0 = 0;
      var last_0 = this.s2b_1;
      if (inductionVariable_0 < last_0)
        $l$loop_0: do {
          var i_0 = inductionVariable_0;
          inductionVariable_0 = inductionVariable_0 + 1 | 0;
          if (this.r2b_1[i_0] === oldRehashIndex) {
            this.r2b_1[i_0] = newIndex;
            break $l$loop_0;
          }
        }
         while (inductionVariable_0 < last_0);
      nextIndex = (nextIndex + 1 | 0) & (this.o2b_1.length - 1 | 0);
    }
    return oldValue;
  };
  ...
  protoOf(CaseInsensitiveMap).equals = function (other) {
    ...
    if (!(other instanceof CaseInsensitiveMap))
      return false;
    if (!(other.d1() === this.q2b_1))
      return false;
    var inductionVariable = 0;
    var last = this.o2b_1.length - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
    ...
    if (inductionVariable <= last)
      do {
        ...
        if (!(k == null)) {
          ...
          var tmp0_safe_receiver = this.p2b_1[i];
  ...
  function SilentSupervisor(parent) {
    ...
    return tmp.gf(tmp$ret$0);
  }
  function SilentSupervisor$$inlined$CoroutineExceptionHandler$1() {
    AbstractCoroutineContextElement.call(this, Key_instance);
  }
  protoOf(SilentSupervisor$$inlined$CoroutineExceptionHandler$1).oy = function (context, exception) {
    return Unit_instance;
  };
  var digits;
  ...
  function PlatformUtils() {
    ...
    if (platform instanceof Js) {
      tmp_0 = platform.x2c_1.equals(JsPlatform_Browser_getInstance());
    } else {
      if (platform instanceof WasmJs) {
        tmp_0 = platform.w2c_1.equals(JsPlatform_Browser_getInstance());
      } else {
        tmp_0 = false;
      }
    }
    ...
    if (platform_0 instanceof Js) {
      tmp_2 = platform_0.x2c_1.equals(JsPlatform_Node_getInstance());
    } else {
      if (platform_0 instanceof WasmJs) {
        tmp_2 = platform_0.w2c_1.equals(JsPlatform_Node_getInstance());
      } else {
        tmp_2 = false;
      }
    }
    ...
    tmp_3.a2d_1 = tmp_4 instanceof Js;
    var tmp_5 = this;
    var tmp_6 = get_platform(this);
    tmp_5.b2d_1 = tmp_6 instanceof WasmJs;
    this.c2d_1 = equals_0(get_platform(this), Jvm_getInstance());
    this.d2d_1 = equals_0(get_platform(this), Native_getInstance());
    this.e2d_1 = get_isDevelopmentMode(this);
    this.f2d_1 = true;
  }
  ...
  function Js(jsPlatform) {
    Platform.call(this);
    this.x2c_1 = jsPlatform;
  }
  protoOf(Js).toString = function () {
    return 'Js(jsPlatform=' + this.x2c_1.toString() + ')';
  };
  ...
  function appendAll(_this__u8e3s4, builder) {
    ...
    // Inline function 'kotlin.collections.forEach' call
    var _iterator__ex2g4s = builder.g2d().t();
    while (_iterator__ex2g4s.u()) {
      var element = _iterator__ex2g4s.v();
      // Inline function 'kotlin.collections.component1' call
      var name = element.l1();
      ...
      _this__u8e3s4.h2d(name, values);
    }
    return _this__u8e3s4;
  }
  function ensureListForKey($this, name) {
    var tmp0_elvis_lhs = $this.j2d_1.p2(name);
    var tmp;
    if (tmp0_elvis_lhs == null) {
  ...
  function StringValuesBuilderImpl(caseInsensitiveName, size) {
    ...
    this.i2d_1 = caseInsensitiveName;
    this.j2d_1 = this.i2d_1 ? caseInsensitiveMap() : LinkedHashMap_init_$Create$(size);
  }
  protoOf(StringValuesBuilderImpl).l2d = function () {
    return this.i2d_1;
  };
  protoOf(StringValuesBuilderImpl).m2d = function (name) {
    return this.j2d_1.p2(name);
  };
  protoOf(StringValuesBuilderImpl).n2d = function () {
    return this.j2d_1.q2();
  };
  protoOf(StringValuesBuilderImpl).r = function () {
    return this.j2d_1.r();
  };
  protoOf(StringValuesBuilderImpl).g2d = function () {
    return unmodifiable(this.j2d_1.k1());
  };
  protoOf(StringValuesBuilderImpl).o2d = function (name, value) {
    this.p2d(value);
    var list = ensureListForKey(this, name);
    list.s2();
    list.b1(value);
  };
  protoOf(StringValuesBuilderImpl).t2c = function (name) {
    var tmp0_safe_receiver = this.m2d(name);
    return tmp0_safe_receiver == null ? null : firstOrNull(tmp0_safe_receiver);
  };
  protoOf(StringValuesBuilderImpl).q2d = function (name, value) {
    this.p2d(value);
    ensureListForKey(this, name).b1(value);
  };
  protoOf(StringValuesBuilderImpl).r2d = function (stringValues) {
    stringValues.s2d(StringValuesBuilderImpl$appendAll$lambda(this));
  };
  protoOf(StringValuesBuilderImpl).h2d = function (name, values) {
  ...
  protoOf(StringValuesBuilderImpl).t2d = function (name) {
    this.j2d_1.x2(name);
  };
  protoOf(StringValuesBuilderImpl).s2 = function () {
    this.j2d_1.s2();
  };
  protoOf(StringValuesBuilderImpl).k2d = function (name) {
  };
  protoOf(StringValuesBuilderImpl).p2d = function (value) {
  };
  ...
  function listForKey($this, name) {
    ...
    var idx = $this.y2d_1[hash & ($this.y2d_1.length - 1 | 0)];
    while (idx >= 0) {
      if (equals($this.v2d_1[idx], name, $this.u2d_1)) {
        return $this.w2d_1[idx];
      }
      idx = $this.z2d_1[idx];
    }
    return null;
  ...
  protoOf(StringValuesEntry).equals = function (other) {
    ...
    var tmp_0;
    if (!(other == null) ? isInterface(other, Entry) : false) {
      tmp_0 = equals_0(other.l1(), this.a2e_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals_0(other.m1(), this.b2e_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(StringValuesEntry).hashCode = function () {
    return getStringHashCode(this.a2e_1) ^ hashCode(this.b2e_1);
  };
  protoOf(StringValuesEntry).toString = function () {
    return this.a2e_1 + '=' + toString(this.b2e_1);
  };
  ...
  function StringValuesImpl(caseInsensitiveName, values) {
    ...
    this.u2d_1 = caseInsensitiveName;
    if (values.r()) {
      this.x2d_1 = 0;
      var tmp = this;
      // Inline function 'kotlin.emptyArray' call
      ...
      // Inline function 'kotlin.emptyArray' call
      tmp_0.w2d_1 = [];
      this.y2d_1 = new Int32Array(0);
      this.z2d_1 = new Int32Array(0);
    } else if (!this.u2d_1) {
      this.x2d_1 = values.d1();
      var tmp_1 = this;
      // Inline function 'kotlin.arrayOfNulls' call
      var size = this.x2d_1;
      var tmp_2 = Array(size);
      tmp_1.v2d_1 = isArray(tmp_2) ? tmp_2 : THROW_CCE();
      var tmp_3 = this;
      // Inline function 'kotlin.arrayOfNulls' call
      var size_0 = this.x2d_1;
      var tmp_4 = Array(size_0);
      tmp_3.w2d_1 = isArray(tmp_4) ? tmp_4 : THROW_CCE();
      var tableSize = tableSizeFor(Companion_instance_1, this.x2d_1);
      var tmp_5 = this;
      var tmp_6 = 0;
      ...
      while (_iterator__ex2g4s_0.u()) {
        ...
        var existing = deduped.p2(key_0);
        if (!(existing == null)) {
          // Inline function 'kotlin.collections.set' call
          var value_1 = plus(existing, value_0);
          deduped.w2(key_0, value_1);
        } else {
          // Inline function 'kotlin.collections.set' call
          deduped.w2(key_0, value_0);
        }
      }
      this.x2d_1 = deduped.d1();
      var tmp_13 = this;
      // Inline function 'kotlin.arrayOfNulls' call
      var size_2 = this.x2d_1;
      var tmp_14 = Array(size_2);
      tmp_13.v2d_1 = isArray(tmp_14) ? tmp_14 : THROW_CCE();
      var tmp_15 = this;
      // Inline function 'kotlin.arrayOfNulls' call
      var size_3 = this.x2d_1;
      var tmp_16 = Array(size_3);
      tmp_15.w2d_1 = isArray(tmp_16) ? tmp_16 : THROW_CCE();
      var tableSize_0 = tableSizeFor(Companion_instance_1, this.x2d_1);
      var tmp_17 = this;
      var tmp_18 = 0;
      ...
      while (_iterator__ex2g4s_1.u()) {
        ...
        if (inductionVariable_0 < size_4)
          do {
            ...
            inductionVariable_0 = inductionVariable_0 + 1 | 0;
            var tmp$ret$30 = value_2.e1(index_0);
            list_0.b1(tmp$ret$30);
          }
           while (inductionVariable_0 < size_4);
        this.w2d_1[tmp_24] = list_0;
        var hash_0 = computeHash(this, key_1);
        var bucket_0 = hash_0 & (tableSize_0 - 1 | 0);
        this.z2d_1[i_0] = this.y2d_1[bucket_0];
        this.y2d_1[bucket_0] = i_0;
        i_0 = i_0 + 1 | 0;
      }
    }
  }
  protoOf(StringValuesImpl).l2d = function () {
    return this.u2d_1;
  };
  protoOf(StringValuesImpl).t2c = function (name) {
    var tmp0_safe_receiver = listForKey(this, name);
    return tmp0_safe_receiver == null ? null : firstOrNull(tmp0_safe_receiver);
  };
  protoOf(StringValuesImpl).m2d = function (name) {
    return listForKey(this, name);
  };
  protoOf(StringValuesImpl).n2d = function () {
    if (this.x2d_1 === 0)
      return emptySet();
  ...
  protoOf(StringValuesImpl).g2d = function () {
    if (this.x2d_1 === 0)
      return emptySet();
    // Inline function 'kotlin.collections.linkedSetOf' call
    var result = LinkedHashSet_init_$Create$();
    ...
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        result.b1(new StringValuesEntry(this.v2d_1[i], this.w2d_1[i]));
      }
       while (inductionVariable < last);
    return result;
  };
  protoOf(StringValuesImpl).s2d = function (body) {
    var inductionVariable = 0;
    var last = this.x2d_1;
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        body(this.v2d_1[i], this.w2d_1[i]);
      }
       while (inductionVariable < last);
  };
  protoOf(StringValuesImpl).toString = function () {
    return 'StringValues(case=' + !this.u2d_1 + ') ' + toString(this.g2d());
  };
  protoOf(StringValuesImpl).equals = function (other) {
    ...
    if (!(!(other == null) ? isInterface(other, StringValues) : false))
      return false;
    if (!(this.u2d_1 === other.l2d()))
      return false;
    return entriesEquals(this.g2d(), other.g2d());
  };
  protoOf(StringValuesImpl).hashCode = function () {
    return entriesHashCode(this.g2d(), imul(31, getBooleanHashCode(this.u2d_1)));
  };
  function StringValuesSingleImpl$entries$1(this$0) {
    this.c2e_1 = this$0.f2e_1;
    this.d2e_1 = this$0.g2e_1;
  }
  ...
  protoOf(StringValuesSingleImpl$entries$1).equals = function (other) {
    ...
    var tmp_0;
    if (!(other == null) ? isInterface(other, Entry) : false) {
      tmp_0 = equals_0(other.l1(), this.c2e_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals_0(other.m1(), this.d2e_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(StringValuesSingleImpl$entries$1).hashCode = function () {
    return getStringHashCode(this.c2e_1) ^ hashCode(this.d2e_1);
  };
  function StringValuesSingleImpl(caseInsensitiveName, name, values) {
    this.e2e_1 = caseInsensitiveName;
    this.f2e_1 = name;
    this.g2e_1 = values;
  }
  protoOf(StringValuesSingleImpl).l2d = function () {
    return this.e2e_1;
  };
  protoOf(StringValuesSingleImpl).m2d = function (name) {
    return equals(this.f2e_1, name, this.l2d()) ? this.g2e_1 : null;
  };
  protoOf(StringValuesSingleImpl).g2d = function () {
    return setOf(new StringValuesSingleImpl$entries$1(this));
  };
  protoOf(StringValuesSingleImpl).r = function () {
    return false;
  };
  protoOf(StringValuesSingleImpl).n2d = function () {
    return setOf(this.f2e_1);
  };
  protoOf(StringValuesSingleImpl).toString = function () {
    return 'StringValues(case=' + !this.l2d() + ') ' + toString(this.g2d());
  };
  protoOf(StringValuesSingleImpl).hashCode = function () {
    return entriesHashCode(this.g2d(), imul(31, getBooleanHashCode(this.l2d())));
  };
  protoOf(StringValuesSingleImpl).equals = function (other) {
    ...
    if (!(!(other == null) ? isInterface(other, StringValues) : false))
      return false;
    if (!(this.l2d() === other.l2d()))
      return false;
    return entriesEquals(this.g2d(), other.g2d());
  };
  protoOf(StringValuesSingleImpl).s2d = function (body) {
    return body(this.f2e_1, this.g2e_1);
  };
  protoOf(StringValuesSingleImpl).t2c = function (name) {
    return equals(name, this.f2e_1, this.l2d()) ? firstOrNull(this.g2e_1) : null;
  };
  ...
  function CopyOnWriteHashMap() {
    this.h2e_1 = atomic$ref$1(emptyMap());
  }
  protoOf(CopyOnWriteHashMap).i2e = function (key) {
    return this.h2e_1.kotlinx$atomicfu$value.p2(key);
  };
  ...
  function Companion_1() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.j2e_1 = [null, null, null, tmp_1, null, null, lazy(tmp_2, GMTDate$Companion$$childSerializers$_anonymous__gyfycy_0), null, null];
    this.k2e_1 = GMTDate_0(new Long(0, 0));
  }
  ...
  function $serializer() {
    ...
    tmp0_serialDesc.q21('seconds', false);
    tmp0_serialDesc.q21('minutes', false);
    tmp0_serialDesc.q21('hours', false);
    tmp0_serialDesc.q21('dayOfWeek', false);
    tmp0_serialDesc.q21('dayOfMonth', false);
    tmp0_serialDesc.q21('dayOfYear', false);
    tmp0_serialDesc.q21('month', false);
    tmp0_serialDesc.q21('year', false);
    tmp0_serialDesc.q21('timestamp', false);
    this.l2e_1 = tmp0_serialDesc;
  }
  protoOf($serializer).m2e = function (encoder, value) {
    var tmp0_desc = this.l2e_1;
    var tmp1_output = encoder.d1u(tmp0_desc);
    var tmp2_cached = Companion_getInstance_1().j2e_1;
    tmp1_output.m1v(tmp0_desc, 0, value.n2e_1);
    tmp1_output.m1v(tmp0_desc, 1, value.o2e_1);
    tmp1_output.m1v(tmp0_desc, 2, value.p2e_1);
    tmp1_output.t1v(tmp0_desc, 3, tmp2_cached[3].m1(), value.q2e_1);
    tmp1_output.m1v(tmp0_desc, 4, value.r2e_1);
    tmp1_output.m1v(tmp0_desc, 5, value.s2e_1);
    tmp1_output.t1v(tmp0_desc, 6, tmp2_cached[6].m1(), value.t2e_1);
    tmp1_output.m1v(tmp0_desc, 7, value.u2e_1);
    tmp1_output.n1v(tmp0_desc, 8, value.v2e_1);
    tmp1_output.e1u(tmp0_desc);
  };
  protoOf($serializer).y1q = function (encoder, value) {
    return this.m2e(encoder, value instanceof GMTDate ? value : THROW_CCE());
  };
  protoOf($serializer).z1q = function (decoder) {
    ...
    var tmp14_cached = Companion_getInstance_1().j2e_1;
    if (tmp13_input.s1u()) {
      tmp4_local0 = tmp13_input.i1u(tmp0_desc, 0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp13_input.i1u(tmp0_desc, 1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
      tmp6_local2 = tmp13_input.i1u(tmp0_desc, 2);
      tmp3_bitMask0 = tmp3_bitMask0 | 4;
      tmp7_local3 = tmp13_input.p1u(tmp0_desc, 3, tmp14_cached[3].m1(), tmp7_local3);
      tmp3_bitMask0 = tmp3_bitMask0 | 8;
      tmp8_local4 = tmp13_input.i1u(tmp0_desc, 4);
      tmp3_bitMask0 = tmp3_bitMask0 | 16;
      tmp9_local5 = tmp13_input.i1u(tmp0_desc, 5);
      tmp3_bitMask0 = tmp3_bitMask0 | 32;
      tmp10_local6 = tmp13_input.p1u(tmp0_desc, 6, tmp14_cached[6].m1(), tmp10_local6);
      tmp3_bitMask0 = tmp3_bitMask0 | 64;
      tmp11_local7 = tmp13_input.i1u(tmp0_desc, 7);
      tmp3_bitMask0 = tmp3_bitMask0 | 128;
      tmp12_local8 = tmp13_input.j1u(tmp0_desc, 8);
  ...
  protoOf($serializer).f22 = function () {
    var tmp0_cached = Companion_getInstance_1().j2e_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
  ...
  function GMTDate_init_$Init$(seen0, seconds, minutes, hours, dayOfWeek, dayOfMonth, dayOfYear, month, year, timestamp, serializationConstructorMarker, $this) {
    if (!(511 === (511 & seen0))) {
      throwMissingFieldException(seen0, 511, $serializer_getInstance().l2e_1);
    }
    $this.n2e_1 = seconds;
    $this.o2e_1 = minutes;
    $this.p2e_1 = hours;
    $this.q2e_1 = dayOfWeek;
    $this.r2e_1 = dayOfMonth;
    $this.s2e_1 = dayOfYear;
    $this.t2e_1 = month;
    $this.u2e_1 = year;
    $this.v2e_1 = timestamp;
    return $this;
  }
  ...
  protoOf(GMTDate).w2e = function (other) {
    return this.v2e_1.g3(other.v2e_1);
  };
  protoOf(GMTDate).d = function (other) {
    return this.w2e(other instanceof GMTDate ? other : THROW_CCE());
  };
  protoOf(GMTDate).toString = function () {
    return 'GMTDate(seconds=' + this.n2e_1 + ', minutes=' + this.o2e_1 + ', hours=' + this.p2e_1 + ', dayOfWeek=' + this.q2e_1.toString() + ', dayOfMonth=' + this.r2e_1 + ', dayOfYear=' + this.s2e_1 + ', month=' + this.t2e_1.toString() + ', year=' + this.u2e_1 + ', timestamp=' + this.v2e_1.toString() + ')';
  };
  protoOf(GMTDate).hashCode = function () {
    var result = this.n2e_1;
    result = imul(result, 31) + this.o2e_1 | 0;
    result = imul(result, 31) + this.p2e_1 | 0;
    result = imul(result, 31) + this.q2e_1.hashCode() | 0;
    result = imul(result, 31) + this.r2e_1 | 0;
    result = imul(result, 31) + this.s2e_1 | 0;
    result = imul(result, 31) + this.t2e_1.hashCode() | 0;
    result = imul(result, 31) + this.u2e_1 | 0;
  ...
  protoOf(GMTDate).equals = function (other) {
    ...
    if (!(other instanceof GMTDate))
      return false;
    if (!(this.n2e_1 === other.n2e_1))
      return false;
    if (!(this.o2e_1 === other.o2e_1))
      return false;
    if (!(this.p2e_1 === other.p2e_1))
      return false;
    if (!this.q2e_1.equals(other.q2e_1))
      return false;
    if (!(this.r2e_1 === other.r2e_1))
      return false;
    if (!(this.s2e_1 === other.s2e_1))
      return false;
    if (!this.t2e_1.equals(other.t2e_1))
      return false;
    if (!(this.u2e_1 === other.u2e_1))
      return false;
    if (!equalsLong(this.v2e_1, other.v2e_1))
      return false;
    return true;
  };
  ...
  protoOf(Companion_2).x2e = function (ordinal) {
  ...
  protoOf(Companion_3).x2e = function (ordinal) {
  ...
  protoOf(LockFreeLinkedListNode).w14 = function () {
  ...
  protoOf(LockFreeLinkedListNode).g2f = function () {
    return unwrap(this.w14());
  };
  ...
  function unwrap(_this__u8e3s4) {
    ...
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.i2f_1;
    var tmp;
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          ...
          case 2:
            this.t2f_1 = this.r2f_1.v2f_1;
            if (this.s2f_1 >= this.t2f_1.d1()) {
              this.r2f_1.z2f();
              this.i8_1 = 5;
              continue $sm;
            } else {
          ...
          case 3:
            var executeInterceptor = this.t2f_1.e1(this.s2f_1);
            this.r2f_1.y2f_1 = this.s2f_1 + 1 | 0;
            this.i8_1 = 4;
            suspendResult = executeInterceptor(this.r2f_1, this.r2f_1.x2f_1, this);
  ...
  function DebugPipelineContext(context, interceptors, subject, coroutineContext) {
    ...
    this.v2f_1 = interceptors;
    this.w2f_1 = coroutineContext;
    this.x2f_1 = subject;
    this.y2f_1 = 0;
  }
  protoOf(DebugPipelineContext).nr = function () {
    return this.w2f_1;
  };
  protoOf(DebugPipelineContext).a2g = function () {
    return this.x2f_1;
  };
  protoOf(DebugPipelineContext).z2f = function () {
    this.y2f_1 = -1;
  };
  protoOf(DebugPipelineContext).b2g = function (subject, $completion) {
    this.x2f_1 = subject;
    return this.c2g($completion);
  };
  protoOf(DebugPipelineContext).c2g = function ($completion) {
    var index = this.y2f_1;
    if (index < 0)
      return this.x2f_1;
    if (index >= this.v2f_1.d1()) {
      this.z2f();
      return this.x2f_1;
    }
    return proceedLoop(this, $completion);
  };
  protoOf(DebugPipelineContext).d2g = function (initial, $completion) {
    this.y2f_1 = 0;
    this.x2f_1 = initial;
    return this.c2g($completion);
  };
  function PhaseContent_init_$Init$(phase, relation, $this) {
    var tmp = Companion_getInstance_4().e2g_1;
    PhaseContent.call($this, phase, relation, isInterface(tmp, KtMutableList) ? tmp : THROW_CCE());
    // Inline function 'kotlin.check' call
    if (!Companion_getInstance_4().e2g_1.r()) {
  ...
  function copiedInterceptors($this) {
    return toMutableList($this.h2g_1);
  }
  function copyInterceptors($this) {
    $this.h2g_1 = copiedInterceptors($this);
    $this.i2g_1 = false;
  }
  ...
  function PhaseContent(phase, relation, interceptors) {
    ...
    this.f2g_1 = phase;
    this.g2g_1 = relation;
    this.h2g_1 = interceptors;
    this.i2g_1 = true;
  }
  protoOf(PhaseContent).j2g = function () {
    return this.h2g_1.r();
  };
  protoOf(PhaseContent).d1 = function () {
    return this.h2g_1.d1();
  };
  protoOf(PhaseContent).k2g = function (interceptor) {
    if (this.i2g_1) {
      copyInterceptors(this);
    }
    this.h2g_1.b1(interceptor);
  };
  protoOf(PhaseContent).l2g = function (destination) {
    var interceptors = this.h2g_1;
    ...
    if (inductionVariable < last)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        destination.b1(interceptors.e1(index));
      }
       while (inductionVariable < last);
  };
  protoOf(PhaseContent).m2g = function () {
    this.i2g_1 = true;
    return this.h2g_1;
  };
  protoOf(PhaseContent).toString = function () {
    return 'Phase `' + this.f2g_1.n2g_1 + '`, ' + this.d1() + ' handlers';
  };
  ...
  function createContext($this, context, subject, coroutineContext) {
    return pipelineContextFor(context, sharedInterceptorsList($this), subject, coroutineContext, $this.v2g());
  }
  function findPhase($this, phase) {
    var phasesList = $this.q2g_1;
    var inductionVariable = 0;
    ...
    if (inductionVariable < last)
      do {
        ...
        if (current === phase) {
          ...
          phasesList.t2(index, content);
          return content;
        }
        var tmp;
        if (current instanceof PhaseContent) {
          tmp = current.f2g_1 === phase;
        } else {
          tmp = false;
        }
        if (tmp) {
  ...
  function cacheInterceptors($this) {
    var interceptorsQuantity = $this.r2g_1;
    if (interceptorsQuantity === 0) {
      notSharedInterceptorsList($this, emptyList());
      return emptyList();
    }
    var phases = $this.q2g_1;
    if (interceptorsQuantity === 1) {
      ...
      if (inductionVariable <= last)
        $l$loop_0: do {
          ...
          if (phaseContent.j2g())
            continue $l$loop_0;
          var interceptors = phaseContent.m2g();
  ...
  function setInterceptorsListFromPhase($this, phaseContent) {
    _set_interceptors__wod97b($this, phaseContent.m2g());
    $this.t2g_1 = false;
    $this.u2g_1 = phaseContent.f2g_1;
  }
  function tryAddToPhaseFastPath($this, phase, block) {
    var currentInterceptors = _get_interceptors__h4min7($this);
    if ($this.q2g_1.r() || currentInterceptors == null) {
      return false;
    }
    var tmp;
    if ($this.t2g_1) {
    ...
    if (equals_0($this.u2g_1, phase)) {
      currentInterceptors.b1(block);
      return true;
    }
    if (equals_0(phase, last($this.q2g_1)) || findPhaseIndex($this, phase) === get_lastIndex_0($this.q2g_1)) {
      ensureNotNull(findPhase($this, phase)).k2g(block);
      currentInterceptors.b1(block);
      return true;
    }
    return false;
  ...
  function Pipeline(phases) {
    this.o2g_1 = AttributesJsFn(true);
    this.p2g_1 = false;
    this.q2g_1 = mutableListOf(phases.slice());
    this.r2g_1 = 0;
    this.s2g_1 = atomic$ref$1(null);
    this.t2g_1 = false;
    this.u2g_1 = null;
  }
  protoOf(Pipeline).v2g = function () {
    return this.p2g_1;
  };
  protoOf(Pipeline).w2g = function (context, subject, $completion) {
    // Inline function 'kotlin.js.getCoroutineContext' call
    var tmp$ret$0 = $completion.o8();
    return createContext(this, context, subject, tmp$ret$0).d2g(subject, $completion);
  };
  protoOf(Pipeline).y2g = function (reference, phase) {
    ...
    var last = get_lastIndex_0(this.q2g_1);
    if (inductionVariable <= last)
      $l$loop_0: do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var tmp = this.q2g_1.e1(i);
        var tmp0_safe_receiver = tmp instanceof PhaseContent ? tmp : null;
        var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.g2g_1;
        var tmp_0;
        if (tmp1_elvis_lhs == null) {
          break $l$loop_0;
        } else {
        ...
        var tmp3_elvis_lhs = tmp2_safe_receiver == null ? null : tmp2_safe_receiver.z2g_1;
        var tmp_1;
       ...
       while (!(i === last));
    this.q2g_1.u2(lastRelatedPhaseIndex + 1 | 0, PhaseContent_init_$Create$(phase, new After(reference)));
  };
  protoOf(Pipeline).a2h = function (reference, phase) {
    if (hasPhase(this, phase))
      return Unit_instance;
    var index = findPhaseIndex(this, reference);
    if (index === -1) {
    ...
    this.q2g_1.u2(index, PhaseContent_init_$Create$(phase, new Before(reference)));
  };
  protoOf(Pipeline).b2h = function (phase, block) {
    ...
    if (tryAddToPhaseFastPath(this, phase, block)) {
      this.r2g_1 = this.r2g_1 + 1 | 0;
      return Unit_instance;
    }
    phaseContent.k2g(block);
    this.r2g_1 = this.r2g_1 + 1 | 0;
    resetInterceptorsList(this);
    this.c2h();
  };
  protoOf(Pipeline).c2h = function () {
  };
  ...
  function After(relativeTo) {
    ...
    this.z2g_1 = relativeTo;
  }
  function Before(relativeTo) {
    PipelinePhaseRelation.call(this);
    this.d2h_1 = relativeTo;
  }
  function Last() {
    Last_instance = this;
    PipelinePhaseRelation.call(this);
  ...
  function loop($this, direct) {
    do {
      var currentIndex = $this.k2h_1;
      if (currentIndex === $this.f2h_1.d1()) {
        if (!direct) {
          // Inline function 'kotlin.Companion.success' call
          var value = $this.h2h_1;
      ...
      $this.k2h_1 = currentIndex + 1 | 0;
      var next = $this.f2h_1.e1(currentIndex);
      try {
        var result = pipelineStartCoroutineUninterceptedOrReturn(next, $this, $this.h2h_1, $this.g2h_1);
  ...
  function resumeRootWith($this, result) {
    ...
    var next = ensureNotNull($this.i2h_1[$this.j2h_1]);
    var _unary__edvuaz = $this.j2h_1;
    $this.j2h_1 = _unary__edvuaz - 1 | 0;
    $this.i2h_1[_unary__edvuaz] = null;
    var interceptor = next.o8().v8(Key_instance_0);
    var tmp;
    if (interceptor instanceof CoroutineDispatcher) {
      tmp = interceptor.ky(next.o8()) ? intercepted(next) : next;
    } else {
  ...
  function SuspendFunctionGun$continuation$1(this$0) {
    this.m2h_1 = this$0;
    this.l2h_1 = -2147483648;
  }
  protoOf(SuspendFunctionGun$continuation$1).o8 = function () {
    var inductionVariable = this.m2h_1.j2h_1;
    if (0 <= inductionVariable)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + -1 | 0;
        var cont = this.m2h_1.i2h_1[index];
  ...
  protoOf(SuspendFunctionGun$continuation$1).xe = function (result) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      resumeRootWith(this.m2h_1, tmp$ret$4);
      return Unit_instance;
    }
    loop(this.m2h_1, false);
  };
  ...
  function SuspendFunctionGun(initial, context, interceptors) {
    PipelineContext.call(this, context);
    this.f2h_1 = interceptors;
    var tmp = this;
    tmp.g2h_1 = new SuspendFunctionGun$continuation$1(this);
    this.h2h_1 = initial;
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOfNulls' call
    var size = this.f2h_1.d1();
    tmp_0.i2h_1 = Array(size);
    this.j2h_1 = -1;
    this.k2h_1 = 0;
  }
  protoOf(SuspendFunctionGun).nr = function () {
    return this.g2h_1.o8();
  };
  protoOf(SuspendFunctionGun).a2g = function () {
    return this.h2h_1;
  };
  protoOf(SuspendFunctionGun).c2g = function ($completion) {
    var tmp$ret$0;
    $l$block_0: {
      if (this.k2h_1 === this.f2h_1.d1()) {
        tmp$ret$0 = this.h2h_1;
        break $l$block_0;
      }
      this.n2h($completion);
      if (loop(this, true)) {
  ...
  protoOf(SuspendFunctionGun).b2g = function (subject, $completion) {
    this.h2h_1 = subject;
    return this.c2g($completion);
  };
  protoOf(SuspendFunctionGun).d2g = function (initial, $completion) {
    this.k2h_1 = 0;
    if (this.k2h_1 === this.f2h_1.d1())
      return initial;
    this.h2h_1 = initial;
  ...
  protoOf(SuspendFunctionGun).n2h = function (continuation) {
    this.j2h_1 = this.j2h_1 + 1 | 0;
    this.i2h_1[this.j2h_1] = continuation;
  };
  function TypeInfo(type, kotlinType) {
    kotlinType = kotlinType === VOID ? null : kotlinType;
    this.o2h_1 = type;
    this.p2h_1 = kotlinType;
  }
  protoOf(TypeInfo).hashCode = function () {
    var tmp0_safe_receiver = this.p2h_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? this.o2h_1.hashCode() : tmp1_elvis_lhs;
  };
  protoOf(TypeInfo).equals = function (other) {
    ...
    if (!(other instanceof TypeInfo))
      return false;
    var tmp;
    if (!(this.p2h_1 == null) || !(other.p2h_1 == null)) {
      tmp = equals_0(this.p2h_1, other.p2h_1);
    } else {
      tmp = this.o2h_1.equals(other.o2h_1);
    }
    return tmp;
  };
  protoOf(TypeInfo).toString = function () {
    var tmp0_elvis_lhs = this.p2h_1;
    return 'TypeInfo(' + toString(tmp0_elvis_lhs == null ? this.o2h_1 : tmp0_elvis_lhs) + ')';
  };
  ...
  function GMTDate_0(timestamp) {
    ...
    var dayOfWeek = Companion_instance_3.x2e((date.getUTCDay() + 6 | 0) % 7 | 0);
    var month = Companion_instance_4.x2e(date.getUTCMonth());
  ...
  function AttributesJs() {
    ...
    tmp.q2h_1 = LinkedHashMap_init_$Create$_0();
  }
  protoOf(AttributesJs).e2b = function (key) {
    return this.q2h_1.p2(key);
  };
  protoOf(AttributesJs).f2b = function (key) {
    return this.q2h_1.n2(key);
  };
  protoOf(AttributesJs).g2b = function (key, value) {
    // Inline function 'kotlin.collections.set' call
    this.q2h_1.w2(key, value);
  };
  protoOf(AttributesJs).i2b = function (key) {
    this.q2h_1.x2(key);
  };
  protoOf(AttributesJs).j2b = function (key, block) {
    var tmp0_safe_receiver = this.q2h_1.p2(key);
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
    ...
    var this_0 = block();
    // Inline function 'kotlin.collections.set' call
    this.q2h_1.w2(key, this_0);
    return this_0;
  };
  protoOf(AttributesJs).k2b = function () {
    return toList(this.q2h_1.q2());
  };
  ...
  function KtorSimpleLogger$1() {
    var tmp = this;
    var tmp_0;
    switch (PlatformUtils_getInstance().z2c_1 || PlatformUtils_getInstance().y2c_1) {
      case true:
  ...
  protoOf(KtorSimpleLogger$1).s2h = function () {
    return this.r2h_1;
  };
  protoOf(KtorSimpleLogger$1).t2h = function (message) {
    if (this.r2h_1.z2(LogLevel_WARN_getInstance()) > 0)
      return Unit_instance;
    console.warn(message);
  };
  protoOf(KtorSimpleLogger$1).u2h = function (message, cause) {
    if (this.r2h_1.z2(LogLevel_DEBUG_getInstance()) > 0)
      return Unit_instance;
    console.debug('DEBUG: ' + message + ', cause: ' + cause.toString());
  };
  protoOf(KtorSimpleLogger$1).v2h = function (message) {
    if (this.r2h_1.z2(LogLevel_TRACE_getInstance()) > 0)
      return Unit_instance;
    console.debug('TRACE: ' + message);
  };
  function get_isTraceEnabled(_this__u8e3s4) {
    return _this__u8e3s4.s2h().z2(LogLevel_TRACE_getInstance()) <= 0;
  }
  ...
  function pipelineStartCoroutineUninterceptedOrReturn$slambda($interceptor, $context, $subject, resultContinuation) {
    this.e2i_1 = $interceptor;
    this.f2i_1 = $context;
    this.g2i_1 = $subject;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(pipelineStartCoroutineUninterceptedOrReturn$slambda).a1o = function ($completion) {
    var tmp = this.h2i($completion);
    tmp.k8_1 = Unit_instance;
    tmp.l8_1 = null;
    return tmp.q8();
  };
  ...
  protoOf(pipelineStartCoroutineUninterceptedOrReturn$slambda).q8 = function () {
    var suspendResult = this.k8_1;
    $sm: do
      try {
        var tmp = this.i8_1;
        switch (tmp) {
          case 0:
            this.j8_1 = 2;
            this.i8_1 = 1;
            suspendResult = this.e2i_1(this.f2i_1, this.g2i_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(pipelineStartCoroutineUninterceptedOrReturn$slambda).h2i = function (completion) {
    return new pipelineStartCoroutineUninterceptedOrReturn$slambda(this.e2i_1, this.f2i_1, this.g2i_1, completion);
  };
  ...
  function instanceOf(_this__u8e3s4, type) {
    return type.ja(_this__u8e3s4);
  }
  //region block: post-declaration
  protoOf($serializer).g22 = typeParametersSerializers;
  protoOf(AttributesJs).d2b = get;
  protoOf(AttributesJs).h2b = set;
  //endregion
  //region block: init
